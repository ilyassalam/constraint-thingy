...
namespace CSharpUtils.Collections
{
    ...
    /// </summary>
    public sealed class DAryHeapL<T> : DAryHeap
    {
        private T[] _items;
        ...
        public DAryHeapL(int initialSize = DefaultHeapSize, int numberOfChildren = DefaultNumberOfChildren)
        {
            if (initialSize < 1)
            {
