...
namespace CSharpUtils.Collections
{
    ...
    /// </summary>
    public sealed class DAryHeap<T> : DAryHeap
    {
        private T[] _items;
        ...
        public DAryHeap(int initialSize = DefaultHeapSize, int numberOfChildren = DefaultNumberOfChildren)
        {
            if (initialSize < 1)
            {
