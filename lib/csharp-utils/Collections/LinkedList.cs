...
namespace CSharpUtils.Collections
{
    ...
    public static class LL
    {
        ...
        /// </summary>
        [Pure]
        public static LL<T> RemoveFront<T>(this LL<T> list)
        {
            return list.Rest;
        }

        /// <summary>
        /// Removes the first <paramref name="count"/> items from the list.
        /// </summary>
        [Pure]
        public static LL<T> RemoveFront<T>(this LL<T> list, int count)
        {
            LL<T> lst = list;
        ...
        /// </summary>
        [Pure]
        public static LL<T> Push<T>(this LL<T> list, T item)
        {
            return list.AddFront(item);
        }
        ...
        /// </summary>
        [Pure]
        public static LL<T> Pop<T>(this LL<T> list, T item)
        {
    ...
    /// </summary>
    public sealed class LL<T> : IEnumerable<T>
    {
        /// <summary>
